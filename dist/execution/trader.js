...
import { connectOrderBookWebSocket, subscribeToTokens, disconnectOrderBookWebSocket } from './orderbook-ws';
const MIN_SHARES = 5;
 ...
 */
async function waitForBothPositions(upTokenId, downTokenId, targetShares) {
